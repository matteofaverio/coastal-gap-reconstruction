...
Builds the daily aggregation behind `data/oxygen/oxygen_local_btg_diagnostic_features.csv`
...
Ported from the original local BTG diagnostic feature builder,
...
this package restricts this feature arm to diagnostic/appendix use only,
...
def build_local_btg_daily(merged_hourly_path: str | Path, var_name: str) -> pd.DataFrame:
    ...
    eligibility rule (this mirrors the original explicit O3.1/O3.2
