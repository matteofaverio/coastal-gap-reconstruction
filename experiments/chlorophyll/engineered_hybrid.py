...
def reconstruct_gap(
    ...
    # gap_edge_residual: single-gap LOCO evaluation against the rest of the series.
    single = pd.DataFrame([{
        "gap_id": "target_gap", "gap_length": gap_length,
    ...
    preds, _ = gem.run_loco_evaluation(single, target_df, features_df, external_cols)
