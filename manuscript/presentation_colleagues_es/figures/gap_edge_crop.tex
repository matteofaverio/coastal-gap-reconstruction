...
\begin{tikzpicture}[x=0.38cm, y=0.38cm, font=\small,
  ...
  \begin{scope}[shift={(0,0)}]
    \panelbg{Residuo de borde}{mGap}
    \modelchip{mGap}
    \node[font=\scriptsize, text=vgInk, align=center, text width=3.0cm] at (4.72,21.65)
      {HGB, ExtraTrees};

    \howbox{mGap}
    % mecanismo: interpolacion + bordes + covariables -> residuo aprendido
    \node[font=\tiny,text=vgInk,align=center,text width=3.2cm] at (4.75,18.55)
      {interpolación lineal + bordes pre/post + covariables $\phi_t$};
    \draw[flow,line width=0.7pt] (4.75,17.15)--(4.75,16.55);
    \node[font=\scriptsize,text=mGap,align=center,text width=2.8cm] at (4.75,15.55)
      {residuo aprendido $\psi_G$};
    \draw[flow,line width=0.7pt] (4.75,14.15)--(4.75,13.55);
    \node[font=\tiny,text=vgInk,align=center,text width=3.0cm] at (4.75,12.55)
