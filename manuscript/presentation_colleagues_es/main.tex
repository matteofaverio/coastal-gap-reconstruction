...
% demostración práctica en vivo (ver public_export/demo/, rama
% colleague-demo-refresh).
%
...
\begin{frame}[t]{Cómo validamos sin engañarnos}
  ...
  \vskip0.35cm
  \begin{center}
    \resizebox{0.98\textwidth}{!}{\input{figures/fig_validacion_esquema_tikz.tex}}
  \end{center}
  \vfill
...
\begin{frame}[t]{Familia 1: líneas de base simples}
  ...
  \begin{columns}[T]
    \begin{column}{0.40\textwidth}
      \centering
      \adjustbox{max width=\linewidth,max height=6.4cm,center}{\input{figures/simple_baselines_crop.tex}}
    \end{column}
...
\begin{frame}[t]{Familia 2: suavizado solo-objetivo}
  ...
  \begin{columns}[T]
    \begin{column}{0.40\textwidth}
      \centering
      \adjustbox{max width=\linewidth,max height=6.4cm,center}{\input{figures/gaussian_process_crop.tex}}
    \end{column}
    \begin{column}{0.56\textwidth}
      \vskip0.3cm
      {\footnotesize
...
\begin{frame}[t]{Familia 3: tabular con variables externas}
  ...
  \begin{columns}[T]
    \begin{column}{0.40\textwidth}
      \centering
      \adjustbox{max width=\linewidth,max height=6.4cm,center}{\input{figures/external_tabular_crop.tex}}
    \end{column}
    \begin{column}{0.56\textwidth}
      \vskip0.3cm
      {\footnotesize
